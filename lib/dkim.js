...
function DKIMSign(email, options){
    ...
    var dkim = generateDKIMHeader(options.domainName, options.keySelector, options.headerFieldNames || "from:to:cc:subject", headers, body),
        canonicalizedHeaderData = DKIMCanonicalizer.relaxedHeaders(headers, options.headerFieldNames || "from:to:cc:subject"),
...
var DKIMCanonicalizer = {
    ...
    /**
     * <p>Simple body caonnicalization by rfc4871 #3.4.3</p>
     * 
